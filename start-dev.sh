...
directories=("matching-service" "peer-prep" "question-service" "user-service" "collaboration-service" "communication-service" "history-service" "ai-chat-service" "run-service")
